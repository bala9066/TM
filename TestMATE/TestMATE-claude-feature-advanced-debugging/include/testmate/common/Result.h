...
enum class EErrorCode : TInt32 {
    ...
    kUnknownError = -1,
    kInvalidParameter = -2,
    kInvalidArgument = -2,  ///< Alias for kInvalidParameter
    kNullPointer = -3,
    kOutOfMemory = -4,
    kNotImplemented = -5,
    kNotInitialized = -6,
    ...
    kRetryable = -15,           ///< Operation can be retried
    kTemporaryFailure = -16,    ///< Temporary failure, retry recommended
    kCircuitBreakerOpen = -17,  ///< Circuit breaker is open
